...
<head>
  ...
  <style>
  /* Chữ toàn bộ trang màu #C77E49 */
  body, p, a, button, input, label, form {
    color: #C77E49;
  }

  /* Chữ tiêu đề màu #C77E49 in đậm */
  h2.title-page, h2.title-page a, h3, h4, h5, h6 {
    color: #C77E49;
    font-weight: bold;
  }
    /* Màu của giá tiền */
    ...
    /* Màu của giá tiền đen */
    .text-price-black {
      color: #000;
     }
 /* Màu của các mục "Tạm tính," "Phí vận chuyển," và "Tổng cộng" */
.text-subtotal,
.text-shipping,
.text-total {
  color: #C77E49;
...
/* Màu chữ đen cho giá trị cụ thể và chữ "đ" */
.text-subtotal span,
.text-shipping span,
.text-total span,
.text-subtotal span:after,
.text-shipping span:after,
.text-total span:after {
  color: #000;
        ...
        <c:otherwise>
          ...
          <aside class="col-lg-3">
            ...
            <div class="card">
              <div class="card-body">
                <dl class="row mb-0">
  					<dt class="col-xxl-6 col-lg-12 col-6 text-subtotal">Tạm tính:</dt>
  					<dd class="col-xxl-6 col-lg-12 col-6 text-end mb-3 text-subtotal"><span id="temp-price">0</span>₫</dd>
 					 <dt class="col-xxl-6 col-lg-12 col-6 text-shipping">Phí vận chuyển:</dt>
 					 <dd class="col-xxl-6 col-lg-12 col-6 text-end mb-3 text-shipping"><span id="delivery-price">0</span>₫</dd>
 					 <dt class="col-xxl-6 col-lg-12 col-6 text-total">Tổng cộng:</dt>
 					 <dd class="col-xxl-6 col-lg-12 col-6 text-end mb-3 text-total"><strong><span id="total-price">0</span>₫</strong></dd>
				</dl>
              </div> <!-- card-body.// -->
            </div> <!-- card.// -->
