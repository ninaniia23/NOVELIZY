...
.form-check-label[for="radioGender1"],
.form-check-label[for="radioGender2"] {
    color: #C77E49 !important;
}
.form-check-label[for="checkboxPolicy"] {
    color: #007BFF !important; /* Màu xanh giống màu của điều khoản sử dụng */
}
.text-center a {
    color: #C77E49 !important; /* Màu của chữ "Đã có tài khoản" */
}
  </style>
</head>
