...
<style>
  /* Màu và kiểu chữ cho tên sách */
  h2.title {
    color: #C77E49;
    font-weight: bold;
  }

  /* Màu và kiểu chữ cho tác giả, số trang, nhà xuất bản */
  dl.row {
    color: #C77E49;
  }

  /* Màu và kiểu chữ cho tên tác giả Santiago Levine và số 26 */
  dd.col-xl-8.col-sm-7.col-6 {
    color: #000;
  }

  /* Màu và kiểu chữ cho mô tả sách và đánh giá */
  section.section-content.mb-4,
  section.section-content.mb-5 {
    color: #000;
  }
   span.price.h4 {
    color: #C77E49;
  ...
  h3.pb-2, h3#review, h3#review-form {
    color: #C77E49;
    font-weight: bold;
  }
</style>
